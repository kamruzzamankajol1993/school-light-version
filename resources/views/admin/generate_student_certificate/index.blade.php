...
@section('title')
Generate Student Certificate | {{ $ins_name }}
@endsection
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Generate Student Certificate</h4>
...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="float-right d-md-block">
            <div class="dropdown">
                @if (Auth::guard('admin')->user()->can('generate_student_certificate_view'))

<form action="{{ route('print_view_all_or_single_admin_student_certificate') }}" method="post">
    @csrf
                <div class="row">
                    ...
                    <div class="form-group col-md-4 col-sm-12">
                        ...
                        <select name="students_id"  class="form-control form-control-sm">
                            ...
                            <select name="template_id"  class="form-control form-control-sm" required>
                                ...
                                @foreach ($student_certificate as $user_class_update)
    <option value="{{ $user_class_update->id }}" >{{ $user_class_update->certificate_name }}</option>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      url:"{{route('print_view_all_or_single_admin_student_certificate')}}",
      type:"POST",
      data:{'section_id':section_id,'students_id':students_id,'template_id':template_id,'class_id':class_id,'session_id':session_id,'department_id':department_id},
            //dataType:'json',
...
<script type="text/javascript">
    ...
    $("select[name='exam_id']").change(function(){
        ...
        var token = $("input[name='_token']").val();
        $.ajax({
            url: "{{ route('exam_id_template_id_student_certificate') }}",
            method: 'POST',
            data: {id_country:id_country, _token:token},
            success: function(data) {
