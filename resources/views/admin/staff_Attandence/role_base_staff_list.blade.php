...
<div class="row mt-3" >
    <div class="form-group col-md-3 col-sm-12">
        <div class="form-check form-check-inline">
            <input class="form-check-input myCheckbox" data-target="firstDiv" type="checkbox" name="holiday" id="inlineCheckbox1203" value="holiday">
            <label class="form-check-label text-danger" for="inlineCheckbox1203">Check,If Today is Holiday</label>
          </div>
    </div>
    <div class="form-group col-md-12 col-sm-12 myDiv mt-3" id="firstDiv">
    <table class="table table-bordered  table-hover">
        ...
        <tbody>
            @foreach($role_base_staff_list as $key=>$new_details)
          <tr>
            <td scope="row">
            ...
            <td>
                {{ $new_details->first_name.''.$new_details->first_name }}
                <input type="hidden" name="name[]" value="{{ $new_details->first_name.''.$new_details->first_name }}" class="form-control form-control-sm" readonly/>
            </td>
