                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button   type="button" class="btn btn-danger waves-light waves-effect  btn-sm" onclick="deleteTag({{ $newss->id}})" data-toggle="tooltip" title="Delete"><i class="fas fa-trash-alt"></i></button>
                                                        <form id="delete-form-{{ $newss->id }}" action="{{ route('admin.student.delete',$newss->id) }}" method="POST" style="display: none;">
                                                          @method('DELETE')
                                                                                        @csrf
                    ...
                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $newss->$fourth_value.' '.$newss->last_name  }}</td>
