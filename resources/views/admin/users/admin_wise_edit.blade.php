...
<div class="page-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="page-title-box">
                                <h4 class="font-size-18">Ward Admin</h4>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="index.php">Shakho</a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('admin.users') }}">Ward Admin List</a></li>
                                    <li class="breadcrumb-item"><a href="#">Update Ward Admin</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                              ...
                              <form action="{{ route('admin.users.update_admin') }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" class="form-control form-control-sm" id="name" name="id" placeholder="Enter Name" value="{{ $user->id }}">
                        ...
                        <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Update Ward Admin</button>
                    </form>
