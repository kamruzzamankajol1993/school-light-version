...
<div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="float-right d-md-block">
                                <div class="dropdown">
                                @if (Auth::guard('admin')->user()->can('teacher_create'))
<button class="btn btn-primary dropdown-toggle waves-effect  btn-sm waves-light" type="button" data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg">
                                        <i class="far fa-calendar-plus  mr-2"></i> Add New Teacher
                                    </button>
@endif
                                </div>
                            </div>
...
{{ $user->address }}
                                    ...
                                    <td>
                                      @if (Auth::guard('admin')->user()->can('teacher_update'))
      ...
      <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('admin.teacher.update') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <input type="hidden" class="form-control form-control-sm" id="name" name="id" placeholder="Enter Name" value="{{ $user->id }}">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" id="name" name="email" placeholder="Enter Email" value="{{ $user->email }}">
                                                            </div>

                                                            <div class="form-group col-md-6 col-sm-12">
                                                                <label for="password">Address</label>
                                                    <input type="text" class="form-control form-control-sm" id="name" name="address" placeholder="Enter Address" value="{{ $user->address }}">
                                                            </div>
                                                        </div>
...
@endif
                                  ...
                                  @if (Auth::guard('admin')->user()->can('teacher_delete'))
...
<button   type="button" class="btn btn-danger waves-light waves-effect  btn-sm" onclick="deleteTag({{ $user->id}})" data-toggle="tooltip" title="Delete"><i class="fas fa-trash-alt"></i></button>
                    <form id="delete-form-{{ $user->id }}" action="{{ route('admin.teacher.delete',$user->id) }}" method="POST" style="display: none;">
                      @method('DELETE')
                                                    @csrf
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Add New Teacher</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                </button>
            </div>
                        <div class="modal-body">
                            <form class="custom-validation" action="{{ route('admin.teacher.store') }}" method="post" enctype="multipart/form-data">
                              @csrf
                                <div class="row">
...
<div class="row">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="name" name="name" placeholder="Enter Name" >
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" id="name" name="phone" placeholder="Enter Phone" >
                                                            ...
                                                            <div class="form-group col-md-6 col-sm-12">
                                                                <label for="password">Email</label>
                                                    <input type="text" class="form-control form-control-sm" id="name" name="email" placeholder="Enter Email" >
                                                            </div>

                                                            <div class="form-group col-md-6 col-sm-12">
                                                                <label for="password">Address</label>
                                                    <input type="text" class="form-control form-control-sm" id="name" name="address" placeholder="Enter Address" >
                                                            </div>
                                                        </div>
