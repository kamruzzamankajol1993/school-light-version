...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Generate Admit Card</h4>
...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="float-right d-md-block">
            <div class="dropdown">
                @if (Auth::guard('admin')->user()->can('generate_mark_sheet_view'))
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      url:"{{route('print_view_all_or_single_admin_marksheet')}}",
      type:"POST",
...
<script type="text/javascript">
    ...
    $("select[name='exam_id']").change(function(){
        ...
        var token = $("input[name='_token']").val();
        $.ajax({
            url: "{{ route('exam_id_template_id_marksheet') }}",
            method: 'POST',
            data: {id_country:id_country, _token:token},
            success: function(data) {
