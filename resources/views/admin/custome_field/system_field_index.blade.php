...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">System Field Update</h4>
...
<form method="post" action="{{ route('system_field_search_category_wise') }}">
    @csrf
        <div class="row">
            <table class="table table-striped table-bordered dt-responsive nowrap">
                ...
                <tr>
                 ...
                 <td >
                    ...
                    <li id="checkboxlist" class="list-group-item card">
                        <div class="checkbox checkbox-inline">
                            <label><input type="checkbox" name="visibility[]" value="1" id="checkbox1" {{ $new_staff_student->visibility == 1 ? 'checked' : '' }}>Show</label>
                            <label><input type="checkbox"name="visibility[]" value="0" id="checkbox2" {{ $new_staff_student->visibility == 0 ? 'checked' : '' }}>Hide</label>
                        </div>
                        </li>
                 ...
                 <td >
                    ...
                    <li id="checkboxlist" class="list-group-item1 card">
                        <div class="checkbox checkbox-inline">
                            <label><input type="checkbox" name="validation[]" value="1" id="checkbox2" {{ $new_staff_student->validation == 1 ? 'checked' : '' }}>Yes</label>
                            <label><input type="checkbox"name="validation[]" value="0" id="checkbox3" {{ $new_staff_student->validation == 0 ? 'checked' : '' }}>No</label>
                        </div>
                        </li>


                        {{-- <input type="checkbox" name="validation[]" value="1" class="form-check-input" id="customSwitchsizelg" {{ $new_staff_student->validation == 1 ? 'checked' : '' }}/>

                        <label class="form-check-label" for="formCheck1">
                          Yes
                        </label>

                        <input type="checkbox" name="validation[]" value="0" class="form-check-input" id="customSwitchsizelg" {{ $new_staff_student->validation == 0 ? 'checked' : '' }}/>
