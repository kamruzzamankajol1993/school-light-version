...
@section('title')
All Alumni Information | {{ $ins_name }}
@endsection
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select id="session_id" name="session_id" class="form-control form-control-sm">
                                            <option value="">Select Session</option>
                                            @foreach($session_detail as $all_session)

                                            <option value="{{ $all_session->name }}">{{ $all_session->name }}</option>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="search_text_admission" value="" class="form-control form-control-sm"
                                        placeholder="Search By Admission Number" id="student_admission_number">
                                </div>
                            </div>
                            <div class="col-sm-12 mt-3">
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      url:"{{route('admin.search_session_wise_all')}}",
      type:"POST",
      data:{'session_id':session_id,'class_id':class_id,'section_id':section_id,'department_id':department_id},
            //dataType:'json',
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      url:"{{route('admin.search_admission_no_wise')}}",
      type:"POST",
