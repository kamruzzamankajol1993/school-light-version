...
@section('title')
Design Admit Card List | {{ $ins_name }}
@endsection
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Admin Card Design Information</h4>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            @foreach($design_admit_card as $key=>$all_design_admit)
                            <tr>
                                <td>{{ $key+1 }}</td>
                                ...
                                <td>
                                    ...
                                    @if (Auth::guard('admin')->user()->can('design_admit_card_view'))
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-12 text-center">
                                                            ...
                                                            <img src="{{ asset('/') }}{{ $all_design_admit->sign }}"
                                    ...
                                    @if (Auth::guard('admin')->user()->can('design_admit_card_update'))
                                    <button type="button" data-bs-toggle="modal"
                                    ...
                                    <div class="modal fade bs-example-modal-lg{{ $all_design_admit->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('admin.design_admit_card.update') }}"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-6 col-sm-12">
                                                                ...
                                                                <input type="file" class="form-control form-control-sm"
                                                                    id="name" name="sign" placeholder="Enter Sign">
                                                                <img src="{{ asset('/') }}{{$all_design_admit->sign }}"
                                                                    height="50px" />
                                                            </div>
                                    ...
                                    @if (Auth::guard('admin')->user()->can('design_admit_card_delete'))
                                    ...
                                    <form id="delete-form-{{ $all_design_admit->id }}"
                                        action="{{ route('admin.design_admit_card.delete',$all_design_admit->id) }}"
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="custom-validation" action="{{ route('admin.design_admit_card.store') }}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-sm-12">
                                            ...
                                            <input type="file" class="form-control form-control-sm" id="name"
                                                name="sign" placeholder="Enter Sign">
                                        </div>
