...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Fee Type Information</h4>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            @foreach ($fee_type_details as $user)
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (Auth::guard('admin')->user()->can('fee_type_update'))
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Update Fee Type
                                                        Information</h5>
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('admin.fee_type.update') }}"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-6 col-sm-12">
                                                                ...
                                                                <input type="text" class="form-control form-control-sm" id="name"
                                                                    name="name" placeholder="Room Number / Name"
                                                                    value="{{ $user->name }}">
                                                            ...
                                                            <div class="form-group col-md-6 col-sm-12">
                                                                <label for="password">Fee Code</label>
                                                                <input type="text" class="form-control form-control-sm" id="name"
                                                                    name="fee_code" placeholder="Enter Fare"
                                                                    value="{{ $user->fee_code }}">
                                                            </div>
                                    ...
                                    @if (Auth::guard('admin')->user()->can('fee_type_delete'))
                                    ...
                                    <form id="delete-form-{{ $user->id }}"
                                        action="{{ route('admin.fee_type.delete',$user->id) }}" method="POST"
                                        style="display: none;">
                                        @method('DELETE')
                                        @csrf
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Add Fee Type</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('admin.fee_type.store') }}"
                                                        method="POST" enctype="multipart/form-data">
