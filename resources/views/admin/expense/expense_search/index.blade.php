...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Search Expense Information</h4>
                ...
                <div class="col-md-6">
                    <div class="row">
                            ...
                            <input type="hidden" name="ci_csrf_token" value="">               <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Search</label>
                                    <input autofocus="" type="text" value="" name="search_text" id="search_text" class="form-control form-control-sm" placeholder="Search by Expense" autocomplete="off">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      url:"{{route('admin.expense_search')}}",
      type:"POST",
