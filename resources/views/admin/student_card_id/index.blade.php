...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Student Id Design Information</h4>
...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="float-right d-md-block">
            <div class="dropdown">
                @if (Auth::guard('admin')->user()->can('student_id_add'))
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            @foreach($student_card_id as $key=>$all_design_admit)
                            <tr>
                                <td>{{ $key+1 }}</td>
                                ...
                                <td>
                                    ...
                                    @if (Auth::guard('admin')->user()->can('student_id_view'))
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <p class="modal-title" id="exampleModalLabel">View Student Id Card
                                                    </p>
                                    ...
                                    padding-right: 10px;">
                                                ...
                                                font-weight: normal;">{{ $institute_list->address }} </h5>
                                                                ...
                                                                <div class="col-md-12 text-center">
                                                                    ...
                                                                    <p style="font-size: 12px"><span
                                                                            style="font-weight: bold;">Admission no:
                                                                        </span></p>
                                                                    @endif
                                                                    ...
                                                                    <p style="font-size: 12px"><span
                                                                            style="font-weight: bold;">Student Id:
                                                                        </span></p>
                                                                    @endif
                                                                    ...
                                                                    <p style="font-size: 12px"><span
                                                                        ...
                                                                        </span>@if(empty($all_design_admit->section))
                                                                    ...
                                                                    <p style="font-size: 12px"><span
                                                                            style="font-weight: bold;">Emergency:{{ $all_design_admit->school_name }}
                                                                        </span></p>
                                    ...
                                    @if (Auth::guard('admin')->user()->can('student_id_update'))
                                    <button type="button" data-bs-toggle="modal"
                                    ...
                                    <div class="modal fade bs-example-modal-lg{{ $all_design_admit->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('admin.student_id_card.update') }}"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-6 col-sm-12">
                                                                ...
                                                                <input type="text" class="form-control form-control-sm"
                                                                    id="name" name="school_name"
                                                                    placeholder="Enter Emergency Number"
                                                                    value="{{ $all_design_admit->school_name}}">
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-4 col-sm-12">
                                                                <div class="form-check form-switch mb-3" dir="ltr">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        value="1" id="customSwitchsizesm"
                                                                        name="exam_session"
                                                                        {{ 1 == $all_design_admit->exam_session ? 'checked':''  }}>
                                                                    <label class="form-check-label"
                                                                        for="customSwitchsizesm">Session</label>
                                                                </div>
                                                            </div>
                                    ...
                                    @if (Auth::guard('admin')->user()->can('student_id_delete'))
                                    ...
                                    <form id="delete-form-{{ $all_design_admit->id }}"
                                        action="{{ route('admin.student_id_card.delete',$all_design_admit->id) }}"
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="custom-validation" action="{{ route('admin.student_id_card.store') }}" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-sm-12">
                                            <label for="name">Emergency Number</label>
                                            <input type="text" class="form-control form-control-sm" id="name"
                                                name="school_name" placeholder="Enter Emergency Number">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4 col-sm-12">
                                            <div class="form-check form-switch mb-3" dir="ltr">
                                                ...
                                                <label class="form-check-label" for="customSwitchsizesm">Session</label>
                                            </div>
                                        </div>
