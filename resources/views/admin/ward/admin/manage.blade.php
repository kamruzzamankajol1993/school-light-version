...
@section('body')
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="page-title-box">
                                <h4 class="font-size-18">Ward Admin List</h4>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Shakho</a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Ward List</a></li>
                            ...
                            <div class="float-right d-md-block">
                                <div class="dropdown">
                                    <button class="btn btn-primary dropdown-toggle waves-effect waves-light" type="button" data-toggle="modal" data-target=".bs-example-modal-lg">
                                        <i class="far fa-calendar-plus  mr-2"></i> Add New Ward Admin
                                    </button>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                             ...
                                             @endforeach
                                              ...
                                              @endif
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <button type="button" class="btn btn-primary waves-light waves-effect" onclick="window.location.href='{{ route('admin.ward_admin.view',$adminnew->id) }}'"><i class="fa fa-eye"></i></button>


                                                        <a href="{{ route('admin.ward_admin.edit',$adminnew->id) }}" type="button" class="btn btn-primary waves-light waves-effect"><i class="fas fa-pencil-alt"></i></a>
 ...
 <form id="delete-form-{{ $adminnew->id }}" action="{{ route('admin.ward_admin.destroy',$adminnew->id) }}" method="POST" style="display: none;">
                                                    @csrf
