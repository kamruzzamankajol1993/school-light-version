...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Postal Dispatch Information</h4>
                    ...
                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (Auth::guard('admin')->user()->can('pod_update'))
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Update Postal Dispatch
                                                        Information</h5>
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('admin.postal_dispatch.update') }}"
                                                        ...
                                                        <div class="row mt-3">
                                                            <div class="form-group col-md-6 col-sm-12">
                                                                ...
                                                                <input type="text" class="form-control form-control-sm" id="name" value="{{ $user->to_title }}" name="to_title" placeholder="Enter To Title">
                                                        ...
                                                        <div class="row mt-3">
                                                            <div class="form-group col-md-4 col-sm-12">
                                                                ...
                                                                <input type="text" class="form-control form-control-sm" value="{{ $user->from_title }}" id="name" name="from_title" placeholder="Enter From Title">
                                 ...
                                 <div class="modal fade bs-example-modal-xl{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <tr>
                                                    <th>Document</th>
                                                    <td><a type="button" href="{{ route('postal_dispatch_download',$user->id) }}"  class="btn btn-success btn-sm waves-effect waves-light" autocomplete="off">
                                    ...
                                    @if (Auth::guard('admin')->user()->can('pod_delete'))
                                    ...
                                    <form id="delete-form-{{ $user->id }}"
                                        action="{{ route('admin.postal_dispatch.delete',$user->id) }}" method="POST"
                                        style="display: none;">
                                        @method('DELETE')
                                        @csrf
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Add Postal Dispatch</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('admin.postal_dispatch.store') }}" method="POST" enctype="multipart/form-data">
