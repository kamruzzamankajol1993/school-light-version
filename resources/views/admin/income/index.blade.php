...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Income Information</h4>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            @foreach ($income_details as $user)
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (Auth::guard('admin')->user()->can('income_update'))
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Update Income
                                                        Information</h5>
                                                    ...
                                                    <form action="{{ route('admin.income.update') }}"
                                                        ...
                                                        <div class="row mt-3">
                                                            <div class="form-group col-md-6 col-sm-12">
                                                                ...
                                                                <select name="income_head" class="form-control form-control-sm">

                                                                    <option>---Please Select---</option>
                                                                    @foreach($income_head_details as $all_income)

                                            <option value="{{ $all_income->income_head }}" {{ $user->income_head == $all_income->income_head ? 'selected':'' }}>{{ $all_income->income_head }}</option>
                                                                    @endforeach
                                                                </select>
                                    ...
                                    @if (Auth::guard('admin')->user()->can('income_delete'))
                                    ...
                                    <form id="delete-form-{{ $user->id }}"
                                        action="{{ route('admin.income.delete',$user->id) }}" method="POST"
                                        style="display: none;">
                                        @method('DELETE')
                                        @csrf
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Add Income</h5>
        ...
        <option value="{{ $all_income->income_head }}" >{{ $all_income->income_head }}</option>
                                @endforeach
                            </select>
