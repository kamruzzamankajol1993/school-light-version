...
<?php  $cat_name = DB::table('item_categories')->where('id',$user->category)->value('name');?>
                                ...
                                <td>
                                    @if (Auth::guard('admin')->user()->can('item_update'))
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('admin.item.update') }}" method="POST"
...
<option value="{{ $all_category->id }}" {{ $all_category->id == $user->category ? 'selected':'' }}>{{ $all_category->name }}</option>
...
@endforeach
                                                            ...
                                                            <div class="form-group col-md-12 col-sm-12">
                                                                ...
                                                                <input type="text" class="form-control form-control-sm"
                                                                    id="name" name="unit" placeholder="Enter Unit"
                                                                    value="{{ $user->unit }}">
                                    ...
                                    @if (Auth::guard('admin')->user()->can('item_delete'))
                                    ...
                                    <form id="delete-form-{{ $user->id }}"
                                        action="{{ route('admin.item.delete',$user->id) }}" method="POST"
                                        style="display: none;">
                                        @method('DELETE')
                                        @csrf
